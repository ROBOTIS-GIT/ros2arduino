...
public:
  ...
  UInt8():
    Topic("std_msgs::msg::dds_::UInt8_", STD_MSGS_UINT8_TOPIC),
    data(0)
  { 
  }

  bool serialize(struct MicroBuffer* writer, const UInt8* topic)
  {
  ...
  bool deserialize(struct MicroBuffer* reader, UInt8* topic)
  {
