...
enum TopicIdNumbering 
{
  ...
  STD_MSGS_INT8_TOPIC,
  STD_MSGS_INT16_TOPIC,
  STD_MSGS_INT32_TOPIC,
  STD_MSGS_INT64_TOPIC,
  STD_MSGS_UINT8_TOPIC,
  STD_MSGS_UINT16_TOPIC,
  STD_MSGS_UINT32_TOPIC,
  STD_MSGS_UINT64_TOPIC,
  STD_MSGS_FLOAT32_TOPIC,
  STD_MSGS_FLOAT64_TOPIC,
  ...
  GEOMETRY_MSGS_POSE_WITH_COVARIANCE_TOPIC,
  GEOMETRY_MSGS_TWIST_WITH_COVARIANCE_TOPIC,
