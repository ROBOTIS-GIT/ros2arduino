...
#define UXR_CONFIG_MAX_SESSION_CONNECTION_ATTEMPTS    100
#define UXR_CONFIG_MIN_SESSION_CONNECTION_INTERVAL    100
#define UXR_CONFIG_MIN_HEARTBEAT_TIME_INTERVAL        10
